...
#> [1,]         1  0.3294837 -0.1553071       0
#> [2,]         0 -0.3999278 -1.3039648       1
#> [3,]         1 -0.2912473  0.5367285       1
#> [4,]         1  0.1561159 -0.3529420       0
#> [5,]         1  0.3458619  0.3349161       1
#> [6,]         1  1.3343076  1.3805339       1
```
...
size=200
 treatment=sample(x=c(0,1), size = size, replace = T,prob = c(0.5, 0.5))
  ...
  head(data3)
#>      treatment  mediator1  mediator2 outcome
#> [1,]         1 -0.1168323  0.8940978       0
#> [2,]         0 -0.6378218 -0.1122791       0
#> [3,]         0 -0.1446064  0.1835969       1
#> [4,]         0 -0.2876340  0.3154407       1
#> [5,]         1 -0.3016378  0.7933187       0
#> [6,]         1  0.3279312  0.4812287       0
```
